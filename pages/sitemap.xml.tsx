...
export const getServerSideProps = async ({ res }: any) => {
  ...
  const staticPages = [
    ...
    { url: `${baseUrl}/auth/sign-in`, priority: "0.3" },
    { url: `${baseUrl}/auth/error`, priority: "0.3" },
    { url: `${baseUrl}/auth/sign-out`, priority: "0.3" },
    { url: `${baseUrl}/auth/verify-request`, priority: "0.3" },
  ...
  const urls = [...staticPages, ...papers].sort(
    (a, b) =>
      // Sort by priority
      parseFloat(b.priority) - parseFloat(a.priority)
  );
